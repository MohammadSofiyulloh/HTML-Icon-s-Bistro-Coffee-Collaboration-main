!(function (e, t) {
      ...
      for (
        d = i,
          (function (i) {
            ...
            (t.style.transition = t.style.webkitTransition = 'fadeIn' === r.animation ? 'opacity .4s ease' : 'slideIn' === r.animation ? '' : 'none'),
              'auto' === r.buttons && (('ontouchstart' in window) || 1 === d.length) && (r.buttons = !1);
  ...
  function F(t) {
    r.noScrollbars && ((document.documentElement.style.overflowY = 'hidden'), (document.body.style.overflowY = 'scroll')),
      'block' !== e.style.display &&
        ...
        r.fullScreen && (e.requestFullscreen ? e.requestFullscreen() : e.webkitRequestFullscreen ? e.webkitRequestFullscreen() : e.mozRequestFullScreen && e.mozRequestFullScreen()),
        setTimeout(function () {
  ...
  function I() {
    r.noScrollbars && ((document.documentElement.style.overflowY = 'auto'), (document.body.style.overflowY = 'auto')),
      'none' !== e.style.display &&
        ...
        setTimeout(function () {
          (e.style.display = 'none'),
            ...
            r.bodyClass && document.body.classList && document.body.classList.remove(r.bodyClass),
  ...
  function X(e, t) {
    return !g && e >= 0 && e < t.length
      ? (S(t, r), F(e), !0)
      : e < 0
      ? (r.animation && M('left'), !1)
      : e >= h.length
      ? (r.animation && M('right'), !1)
      : (Y((f = e), function () {
          R(f), z(f);
        }),
        O(),
  ...
  function O() {
    ...
    'fadeIn' === r.animation
      ...
      : c.transforms
      ? (t.style.transform = t.style.webkitTransform = 'translate3d(' + e + ',0,0)')
      : (t.style.left = e);
  }
  function R(e) {
    e - f >= r.preload ||
  ...
  return (
      ...
      }),
    {
      run: function (r, u) {
        var d, f, g, p, b, h;
        return (
          (c.transforms = 'undefined' != typeof (d = W('div')).style.perspective || 'undefined' != typeof d.style.webkitPerspective),
          (c.svg = (((f = W('div')).innerHTML = '<svg/>'), 'http://www.w3.org/2000/svg' === (f.firstChild && f.firstChild.namespaceURI))),
          ...
          (function () {
            ...
            var r;
            (e = W('div')).setAttribute('role', 'dialog'),
              (e.id = 'baguetteBox-overlay'),
              document.getElementsByTagName('body')[0].appendChild(e),
              ((t = W('div')).id = 'baguetteBox-slider'),
              e.appendChild(t),
              (n = W('button')).setAttribute('type', 'button'),
              (n.id = 'previous-button'),
              n.setAttribute('aria-label', 'Previous'),
              (n.innerHTML = c.svg ? a : '&lt;'),
              e.appendChild(n),
              (o = W('button')).setAttribute('type', 'button'),
              (o.id = 'next-button'),
              o.setAttribute('aria-label', 'Next'),
              (o.innerHTML = c.svg ? s : '&gt;'),
              e.appendChild(o),
              (i = W('button')).setAttribute('type', 'button'),
              (i.id = 'close-button'),
              i.setAttribute('aria-label', 'Close'),
              (i.innerHTML = c.svg ? l : '&times;'),
              e.appendChild(i),
              (n.className = o.className = i.className = 'baguetteBox-button'),
              (r = c.passiveEvents ? { passive: !0 } : null),
              D(e, 'click', w),
              D(n, 'click', k),
              D(o, 'click', x),
              D(i, 'click', C),
