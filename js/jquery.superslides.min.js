  ...
  (n = function (n, e) {
    ...
    var r = function () {
        return (
          ...
          t(i).on('resize', function () {
            setTimeout(function () {
              ...
              (s.width = s._findWidth()), (s.height = s._findHeight()), i.css({ width: s.width, left: s.width }), s.css.containers(), s.css.images();
            }, 10);
          }),
      ...
      h = {
        containers: function () {
          s.init
            ? (s.$el.css({ height: s.height }), s.$control.css({ width: s.width * a, left: -s.width }), s.$container.css({}))
            : (t('body').css({ margin: 0 }),
              s.$el.css({ position: 'relative', overflow: 'hidden', width: '100%', height: s.height }),
              s.$control.css({ position: 'relative', transform: 'translate3d(0)', height: '100%', width: s.width * a, left: -s.width }),
              s.$container.css({ display: 'none', margin: '0', padding: '0', listStyle: 'none', position: 'relative', height: '100%' })),
            1 === s.size() && s.$el.find(s.options.elements.nav).hide();
        },
        images: function () {
          var i = s.$container.find('img').not(s.options.elements.preserve);
          i.removeAttr('width').removeAttr('height').css({ '-webkit-backface-visibility': 'hidden', '-ms-interpolation-mode': 'bicubic', position: 'absolute', left: '0', top: '0', 'z-index': '-1', 'max-width': 'none' }),
            i.each(function () {
      ...
      c = {
        ...
        fade: function (i, t) {
          ...
          o.css({ left: this.width, opacity: 0, display: 'block' }).animate({ opacity: 1 }, n.options.animation_speed, n.options.animation_easing),
            i.outgoing_slide >= 0
              ? s.animate({ opacity: 0 }, n.options.animation_speed, n.options.animation_easing, function () {
      ...
      animate: function (t, n) {
        ...
        if (!(this.animating || ((this.animating = !0), void 0 === t && (t = 'next'), (s.upcoming_slide = this._upcomingSlide(t)), s.upcoming_slide >= this.size()))) {
          if (
            ...
            ('prev' === t || s.outgoing_slide > t) && ((s.upcoming_position = 0), (s.offset = 0)),
